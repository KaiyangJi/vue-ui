            ...
            <div class="picker"  :class="[pickerShow?'show':'']">
                ...
                <div class="pick-box">
                    <div class="content" >
                        ...
                        <div class="content-item" v-if="level==2 || level==3">
                            <div class="picker-item"  v-picker.secondList="{set:set}" ref="secondList" :data-index="cIndex">
                                <div class="item" :class="{on :index==cIndex}" v-for="(val,index) of secondList" :key="index">{{val[label].name|| val.name}}</div>
                            </div>
                        </div>
                        <div class="content-item" v-if="level==3">
                            <div class="picker-item" v-picker.thirdList="{set:set}" ref="thirdList" :data-index="tIndex">
    ...
    export default {
      ...
      watch: {
        ...
        itemHeigth(val) {
          this.$refs.firstList.style.transform = `translateY(${-this.itemHeigth * this.pIndex}px)`;
          if (this.level == 2 || this.level == 3) {
            this.$refs.secondList.style.transform = `translateY(${-this.itemHeigth * this.cIndex}px)`;
          }
          if (this.level == 3) {
            this.$refs.thirdList.style.transform = `translateY(${-this.itemHeigth * this.tIndex}px)`;
          }
        },
      },
      directives: {
